...
jQuery(document).ready(function (e) {
  ...
  window.innerWidth <= 760 &&
    (_ = Math.round((window.innerWidth / 760) * 110)) < 40 &&
  ...
  var k = function (e) {
    ...
    I = {
      ...
      openOrSelectSlide: function (t) {
        e(this).jp_carousel("testIfOpened")
          ? i.jp_carousel("selectSlideAtIndex", t)
          : e(this).jp_carousel("open", { start_index: t });
      },
      open: function (d) {
        var m = {
            items_selector:
        ...
        if (
          ...
          ((function () {
            if (!t) {
              ...
              Number(jetpackCarouselStrings.is_logged_in),
                (m = e('<div class="jp-carousel-buttons">' + m + "</div>")),
                ...
                0 < m.children().length && f.append(m),
                f
                  .append(
                ...
                (g = e("<div></div>")
                  ...
                  .css({ width: "100%", "margin-top": f.css("margin-top") }));
              var h = e(window).width() - 2 * _ - (f.width() + 40);
              if (
                ((h += "px"),
                (v = e("<div></div>")
                  .addClass("jp-carousel-left-column-wrapper")
                  .css({ width: Math.floor(h) })
                  .append(g)),
                d)
              ) {
                ...
                jetpackCarouselStrings.local_comments_commenting_as &&
                  ...
                  1 === Number(jetpackCarouselStrings.comment_registration)
                    ? (w +=
                        ...
                        jetpackCarouselStrings.local_comments_commenting_as +
                        "</div>")
                    : ((w += '<form id="jp-carousel-comment-form">'),
                      (w +=
              ...
              (n = e("<div></div>")
                ...
                .append(f)),
                window.innerWidth <= 760
                  ? (p.remove().insertAfter(g), n.prepend(v))
                  : n.append(v);
              var C = e(window).height() - parseInt(n.css("top"), 10) + "px";
              (s = e("<div><span></span></div>")
                .addClass("jp-carousel-next-button")
                .css({ right: "15px" })
                .hide()),
                (r = e("<div><span></span></div>")
                  .addClass("jp-carousel-previous-button")
                  .css({ left: 0 })
                  .hide()),
                s
                  .add(r)
                  .css({ position: "fixed", top: "40px", bottom: C, width: _ }),
                ...
                o
                  ...
                  .click(function (t) {
                    ...
                    if (((r = r || []), a.is(i) || a.parents().add(a).is(u)))
                      o.jp_carousel("close");
                      ...
                      a.parents("#jp-carousel-comment-form-container").length
                    ) {
                      var d = e("#jp-carousel-comment-form-comment-field")
                          .blur(function () {
                        ...
                        p = e("#jp-carousel-comment-form-email-field")
                          .blur(function () {
                            e(window).bind("keydown", k);
                          })
                          .focus(function () {
                        ...
                        m = e("#jp-carousel-comment-form-author-field")
                          .blur(function () {
                            e(window).bind("keydown", k);
                          })
                          .focus(function () {
                        ...
                        h = e("#jp-carousel-comment-form-url-field")
                          .blur(function () {
                            e(window).bind("keydown", k);
                          })
                          .focus(function () {
                      ...
                      if (d && d.attr("id") === a.attr("id"))
                        ...
                        t.preventDefault(),
                          t.stopPropagation(),
                          e("#jp-carousel-comment-form-spinner").show();
                        var f = {
                        ...
                        if (
                          ...
                          (f.url = h.val()),
                          1 ===
                            Number(jetpackCarouselStrings.require_name_email))
                        ) {
                          if (!f.email.length || !f.email.match("@"))
                            return void i.jp_carousel("postCommentError", {
                        ...
                        e.ajax({
                          ...
                          dataType: "json",
                          success: function (t) {
                            "approved" === t.comment_status
                              ? e("#jp-carousel-comment-post-results")
                                  .slideUp("fast")
                                  .html(
                              ...
                              e("#jp-carousel-comment-form-button-submit").val(
                                jetpackCarouselStrings.post_comment
                              ),
                              e("#jp-carousel-comment-form-spinner").hide();
                          },
                          error: function () {
                      ...
                      a.parents(".jp-carousel-info").length ||
                        o.jp_carousel("next");
                  })
                  .bind("jp_carousel.afterOpen", function () {
                    e(window).bind("keydown", k),
                      e(window).bind("resize", S),
                      (i.opened = !0),
                      S();
                  })
                  ...
                  .on(
                    ...
                    function (t) {
                      if ("transform" === t.originalEvent.propertyName) {
                        var a =
                          (Date.now() - l) / 1e3 / t.originalEvent.elapsedTime;
                        o.off("transitionend.jp-carousel"),
                          a >= 2 &&
                            e(".jp-carousel-transitions").removeClass(
          ...
          return (
            ...
            o.data("carousel-extra", h),
            this.each(function () {
              var t = e(this);
              d && e.extend(m, d),
                -1 === m.start_index && (m.start_index = 0),
                o.trigger("jp_carousel.beforeOpen").fadeIn("fast", function () {
                  o.trigger("jp_carousel.afterOpen"),
                    i
                      .jp_carousel(
                        "initSlides",
                        t.find(m.items_selector),
                        m.start_index
                      )
                      .jp_carousel("selectSlideAtIndex", m.start_index);
                }),
                i.html("");
            })
          );
      ...
      updateSlidePositions: function (e) {
        var t = this.jp_carousel("selectedSlide"),
          ...
          n = s.prev(),
          l = r.next(),
          c = Math.floor(0.5 * (a - o));
        t.jp_carousel("setSlidePosition", c).show(),
          i.jp_carousel("fitInfo", e),
          1 === (h.is(t.prevAll()) ? 1 : -1)
            ? (l.is(s) ||
                l.jp_carousel("setSlidePosition", a + r.width()).show(),
              n.is(r) ||
                n.jp_carousel("setSlidePosition", -n.width() - o).show())
            : l.is(s) || l.jp_carousel("setSlidePosition", a + o).show(),
          s
            .jp_carousel("setSlidePosition", Math.floor(-s.width() + 0.75 * _))
            .show(),
          r.jp_carousel("setSlidePosition", Math.ceil(a - 0.75 * _)).show();
      },
      selectSlide: function (t, a) {
        h = this.find(".selected").removeClass("selected");
        var s,
          r,
          n = i.jp_carousel("slides").css({ position: "fixed" }),
          l = e(t).addClass("selected").css({ position: "relative" }),
        ...
        i.jp_carousel("loadFullImage", l),
          c.hide(),
          0 === u.length && n.length <= 2
            ? e(".jp-carousel-next-button").hide()
            : e(".jp-carousel-next-button").show(),
          0 === p.length && n.length <= 2
            ? e(".jp-carousel-previous-button").hide()
            : e(".jp-carousel-previous-button").show(),
        ...
        i.jp_carousel("updateExif", g),
          ...
          1 == +jetpackCarouselStrings.display_comments &&
          ...
          l.data("caption")
            ? ((r = e("<div />").text(l.data("caption")).html()) ===
                e("<div />").text(l.data("title")).html() &&
                e(".jp-carousel-titleanddesc-title").fadeOut("fast").empty(),
              r === e("<div />").text(l.data("desc")).html() &&
                e(".jp-carousel-titleanddesc-desc").fadeOut("fast").empty(),
              c.html(l.data("caption")).fadeIn("slow"))
            : c.fadeOut("fast").empty(),
      ...
      bestFit: function () {
        var e,
          t,
          a = i.jp_carousel("slideDimensions"),
          o = this.jp_carousel("originalDimensions"),
          s = o.width / o.height,
          r = 1,
          n = 1;
        return (
          o.width > a.width && (r = a.width / o.width),
          o.height > a.height && (n = a.height / o.height),
          r < n
            ? ((e = a.width), (t = Math.floor(e / s)))
            : n < r
            ? ((t = a.height), (e = Math.floor(t * s)))
      ...
      fitInfo: function () {
        ...
        return (
          p.css({
            left: Math.floor(0.5 * (n.width() - e.width)),
      ...
      fitMeta: function (t) {
        var a = { top: Math.floor((e(window).height() / 100) * 85 + 5) + "px" },
          i = { width: n.width() - (f.width() + 80) + "px" };
      ...
      fitSlide: function () {
        return this.each(function () {
          ...
          (a.left = 0),
            (a.top = Math.floor(0.5 * (o.height - a.height)) + 40),
            t.css(a);
        });
      },
      ...
      initSlides: function (t, a) {
        t.length < 2
          ? e(".jp-carousel-next-button, .jp-carousel-previous-button").hide()
          : e(".jp-carousel-next-button, .jp-carousel-previous-button").show(),
          t.each(function () {
            var t,
              a = e(this),
              o = a.data("orig-size") || "",
              ...
              l = a.data("large-file") || "";
            (o = { width: parseInt(r[0], 10), height: parseInt(r[1], 10) }),
              (t = a.data("orig-file")),
        ...
        return (
          t.each(function (t) {
            var s = e(this),
              ...
              l = s.data("image-meta") || {},
              c = s.data("orig-size") || "",
              d = { width: s[0].naturalWidth, height: s[0].naturalHeight },
              p = s.data("image-title") || "",
              u = s.data("image-description") || "",
              m =
                s.parents(".gallery-item").find(".gallery-caption").html() ||
                "",
            ...
            if ((v && (m = v), r && c.length)) {
              ...
              var w = e("<img/>")
                ...
                _ = e(
                  ...
                  .data("permalink", s.parents("a").attr("href"))
                  .data("orig-size", c)
                  .data("comments-opened", n)
                  .data("image-meta", l)
                  .data("medium-file", f)
                  .data("large-file", g)
                  .data("orig-file", j)
                  .data("thumb-size", d);
              o &&
                _.data("preview-image", s.attr("src")).css({
      ...
      selectBestImageSize: function (e) {
        ...
        if (a) {
          ...
          return (
            -1 !== d &&
              ((p = e.large_file.substring(0, d)),
              (e.orig_width > e.max_width || e.orig_height > e.max_height) &&
                (p += "?fit=" + e.orig_max_width + "%2C" + e.orig_max_height)),
            p
          );
        }
        return e.orig_file;
      ...
      getImageSizeParts: function (e, t, a) {
        ...
        return (
          "9999" === o[0] && (o[0] = "0"), "9999" === o[1] && (o[1] = "0"), o
        );
      },
      originalDimensions: function () {
        var t = e(this).data("orig-size").split(",");
        return { width: parseInt(t[0], 10), height: parseInt(t[1], 10) };
      },
      format: function (e) {
        if (("object" != typeof e && (e = {}), e.text && void 0 !== e.text))
          return e.replacements && void 0 !== e.replacements
            ? e.text.replace(/{(\d+)}/g, function (t, a) {
      ...
      getTitleDesc: function (t) {
        var a,
          ...
          s = "",
          r = "";
        (o = e("div.jp-carousel-titleanddesc", "div.jp-carousel-wrap")).hide(),
          (s = i.jp_carousel("parseTitleDesc", t.title) || ""),
          (a = i.jp_carousel("parseTitleDesc", t.desc) || ""),
          (s.length || a.length) &&
            (e("<div />").html(s).text() === e("<div />").html(a).text() &&
              (s = ""),
            (r = s.length
              ? '<div class="jp-carousel-titleanddesc-title">' + s + "</div>"
              : ""),
            (r += a.length
              ? '<div class="jp-carousel-titleanddesc-desc">' + a + "</div>"
              : ""),
            o.html(r).fadeIn("slow")),
      ...
      updateExif: function (t) {
        ...
        e.each(t, function (t, o) {
          if (
            0 !== parseFloat(o) &&
            o.length &&
            -1 !== e.inArray(t, e.makeArray(jetpackCarouselStrings.meta_data))
          ) {
            switch (t) {
              case "focal_length":
                o += "mm";
            ...
            a.append(
              "<li><h5>" + jetpackCarouselStrings[t] + "</h5>" + o + "</li>"
            );
          }
        }),
          e("div.jp-carousel-image-meta ul.jp-carousel-image-exif").replaceWith(
            a
          );
      },
      updateFullSizeLink: function (t) {
        ...
        var a,
          o = t.data("orig-size").split(","),
          s = document.createElement("a");
        (s.href = t.data("src").replace(/\?.+$/, "")),
          (a =
            null !== s.hostname.match(/^i[\d]{1}.wp.com$/i)
              ? s.href
              : t.data("orig-file").replace(/\?.+$/, ""));
        var r = e(
          "<a>" +
            i.jp_carousel("format", {
      ...
      testCommentsOpened: function (t) {
        1 === parseInt(t, 10)
          ? (e(".jp-carousel-buttons").fadeIn("fast"), j.fadeIn("fast"))
          : (e(".jp-carousel-buttons").fadeOut("fast"), j.fadeOut("fast"));
      },
            ...
            e.ajax({
              ...
              success: function (s) {
                  ...
                  e(s).each(function () {
                    ...
                    a.append(o),
                      ...
                      (m = setInterval(function () {
                        e(".jp-carousel-overlay").height() - 150 <
                          e(".jp-carousel-wrap").scrollTop() +
                            e(window).height() &&
                          (i.jp_carousel("getComments", {
                ...
                if (r && r.data && r.data("attachment-id") != t.attachment_id)
                  return a.fadeOut("fast"), void a.empty();
                e(".jp-carousel-overlay").height(
                  e(window).height() +
                    g.height() +
                    j.height() +
                    (a.height() > 0 ? a.height() : f.height()) +
                    200
                ),
                  a.show(),
                  o.hide();
      ...
      setCommentIframeSrc: function (t) {
        ...
        a &&
          a.length &&
          (a.attr("src", a.attr("src").replace(/(postid=)\d+/, "$1" + t)),
          a.attr(
            "src",
            a.attr("src").replace(/(%23.+)?$/, "%23jp-carousel-" + t)
          ));
      },
      ...
      nextSlide: function () {
        ...
        return 0 === t.length || (e.length > 2 && t.is(e.last()))
          ? e.first()
          : t.next();
      },
      prevSlide: function () {
        var e = this.jp_carousel("slides"),
          t = this.jp_carousel("selectedSlide");
        return 0 === t.length || (e.length > 2 && t.is(e.first()))
          ? e.last()
          : t.prev();
      },
      loadFullImage: function (t) {
        ...
        a.data("loaded") ||
          (a.on("load.jetpack", function () {
            a.off("load.jetpack"),
              e(this).closest(".jp-carousel-slide").css("background-image", "");
          }),
          !t.data("preview-image") ||
          (t.data("thumb-size") && t.width() > t.data("thumb-size").width)
            ? a
                .attr("src", a.closest(".jp-carousel-slide").data("src"))
                .attr("itemprop", "image")
            : a.attr("src", t.data("preview-image")).attr("itemprop", "image"),
          a.data("loaded", 1));
      },
  ...
  (e.fn.jp_carousel = function (t) {
    return I[t]
      ...
      : "object" != typeof t && t
      ? void e.error("Method " + t + " does not exist on jQuery.jp_carousel")
    ...
    e(document.body).on(
      ...
      function (t) {
        e(this).jp_carousel("testForData", t.currentTarget) &&
          (e(t.target).parent().hasClass("gallery-caption") ||
            e(t.target).parent().is("figcaption") ||
    ...
    e(window).on("hashchange.jp-carousel", function () {
      var t,
        ...
        s,
        r = /jp-carousel-(\d+)/;
      window.location.hash && r.test(window.location.hash)
        ? (window.location.hash === y && i.opened) ||
          (window.location.hash && i && !i.opened && history.back
            ? history.back()
            : ((y = window.location.hash),
              (t = window.location.hash.match(r)),
              (a = parseInt(t[1], 10)),
              e(
                  ...
                  (e(i)
                    ...
                    .each(function (t, o) {
                      if (e(o).data("attachment-id") === parseInt(a, 10))
                        return (s = { index: t, gallery: i }), !1;
                    }),
                  s)
                )
                  return (
                    e(s.gallery).jp_carousel("openOrSelectSlide", s.index), !1
                  );
              })))
          ...
          function s(s) {
            if ((a.preventDefaultEvents && s.preventDefault(), i)) {
              var r = s.touches[0].pageX,
                ...
                l = e - r,
                c = t - n;
              Math.abs(l) >= a.min_move_x
                ? (o(), l > 0 ? a.wipeLeft(s) : a.wipeRight(s))
                : Math.abs(c) >= a.min_move_y &&
                  (o(), c > 0 ? a.wipeDown(s) : a.wipeUp(s));
            }
          }
