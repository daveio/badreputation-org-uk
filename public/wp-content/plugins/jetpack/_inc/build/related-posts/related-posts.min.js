...
!(function (t) {
  var e = {
    ...
    getEndpointURL: function (e) {
      ...
      t("#jp-relatedposts").data("exclude") &&
        (o += "&relatedposts_exclude=" + t("#jp-relatedposts").data("exclude")),
        a && (o += "&jetpackrpcustomize=1");
      var p = s.pathname;
      return (
        "/" !== p[0] && (p = "/" + p),
        "" === s.search ? p + "?" + o : p + s.search + "&" + o
      );
    },
      ...
      return (
        t.each(e, function (t, e) {
          var p = a.getAnchor(e, "jp-relatedposts-post-a"),
            i = "jp-relatedposts-post jp-relatedposts-post" + t;
          e.classes.length > 0 && (i += " " + e.classes.join(" ")),
            ...
            s.showContext &&
              (o +=
                '<span class="jp-relatedposts-post-context">' +
                e.context +
                "</span>"),
            (o += "</p>");
        }),
    ...
    generateVisualHtml: function (e, s) {
      var a = this,
        o = "";
      return (
        t.each(e, function (e, p) {
          var i = a.getAnchor(p, "jp-relatedposts-post-a"),
            r = "jp-relatedposts-post jp-relatedposts-post" + e;
          if (
            (p.classes.length > 0 && (r += " " + p.classes.join(" ")),
            p.img.src
              ? (r += " jp-relatedposts-post-thumbs")
              : (r += " jp-relatedposts-post-nothumbs"),
            (o +=
              '<div class="' +
              r +
              '" data-post-id="' +
    ...
    getTrackedUrl: function (e) {
      ...
      (s += "&relatedposts_origin=" + t(e).data("origin")),
        (s += "&relatedposts_position=" + t(e).data("position"));
      var a = e.pathname;
      return (
        "/" !== a[0] && (a = "/" + a),
        "" === e.search ? a + "?" + s : a + e.search + "&" + s
      );
    },
    cleanupTrackedUrl: function () {
      if ("function" == typeof history.replaceState) {
        var t = document.location.search.replace(
  ...
  function a() {
    ...
    var a = e.getEndpointURL(),
      o = t("#jp-relatedposts");
    t("#jp-relatedposts .jp-relatedposts-post").length
      ? s()
      : t.getJSON(a, function (t) {
          if (0 !== t.items.length && 0 !== o.length) {
            ...
            "undefined" != typeof wp && wp.customize
              ? ((p = wp.customize
                  .instance("jetpack_relatedposts[show_thumbnails]")
                  .get()),
                (i.showDate = wp.customize
                  .instance("jetpack_relatedposts[show_date]")
                  .get()),
                (i.showContext = wp.customize
                  .instance("jetpack_relatedposts[show_context]")
                  .get()),
                (i.layout = wp.customize
                  .instance("jetpack_relatedposts[layout]")
                  .get()))
              : ((p = t.show_thumbnails),
                (i.showDate = t.show_date),
                (i.showContext = t.show_context),
                (i.layout = t.layout)),
              (a = p
                ? e.generateVisualHtml(t.items, i)
                : e.generateMinimalHtml(t.items, i)),
              o.append(a),
              i.showDate &&
                o.find(".jp-relatedposts-post-date").css("display", "block"),
              o.show(),
              s();
          }
        });
  ...
  t(function () {
    "undefined" != typeof wp && wp.customize
      ? (wp.customize.selectiveRefresh &&
        ...
        wp.customize.bind("preview-ready", a))
      : a();
  });
})(jQuery);
